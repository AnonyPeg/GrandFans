const popups = {
  how: {
    ...
    body: `
      ...
      <p class="popup-sub">Alles über Discord. Tritt bei und melde dich direkt – kein Formular, kein Aufwand.</p>
      <div class="psteps">
        <div class="pstep">
          <div class="pstep-num">1</div>
          <div>
            <h4>Discord beitreten</h4>
            <p>Klick auf den Discord-Link und tritt unserem Server bei: <strong style="color:#5865f2">discord.gg/mszX5U6jXW</strong></p>
          </div>
        </div>
        <div class="pstep">
          <div class="pstep-num">2</div>
          <div>
            <h4>Anatoly kontaktieren</h4>
            <p>Schreib Anatoly Federov direkt auf Discord. Alles wird dort individuell und diskret besprochen.</p>
          </div>
        </div>
        <div class="pstep">
          ...
          <div>
            ...
            <p>Du wirst als Creator aufgenommen. Dein Content wird gesperrt – Fans zahlen einmalig pro Inhalt.</p>
          </div>
        </div>
        <div class="pstep">
      ...
      <a href="https://discord.gg/mszX5U6jXW" target="_blank" rel="noopener"
         style="display:inline-flex;align-items:center;justify-content:center;gap:12px;padding:15px 28px;border-radius:14px;background:#5865f2;color:#fff;font-family:'Outfit',sans-serif;font-size:15px;font-weight:800;text-decoration:none;box-shadow:0 8px 28px rgba(88,101,242,.5);width:100%;margin-top:20px;">
  ...
  kontakt: {
    title: '💬 Discord – Kontakt',
    body: `
      <p class="popup-eyebrow">Direkter Kontakt via Discord</p>
      <p class="popup-sub">Alles wird über unseren Discord-Server abgewickelt. Tritt einfach bei und melde dich direkt bei Anatoly Federov.</p>
      <div class="contact-wrap">
        <img src="me.png" alt="Anatoly Federov" class="contact-avatar"
             onerror="this.style.background='linear-gradient(135deg,#5865f2,#6c3bdb)';this.removeAttribute('src')">
        ...
        <div class="contact-items">
          <div class="contact-item">
            ...
            <span>Discord – Primärer Kontaktweg</span>
          </div>
          <div class="contact-item">
            <span style="font-size:17px">🎮</span>
            <span>GrandRP – In-Character abgewickelt</span>
          </div>
          <div class="contact-item">
            <span style="font-size:17px">💼</span>
        ...
        <a href="https://discord.gg/mszX5U6jXW" target="_blank" rel="noopener"
           style="display:inline-flex;align-items:center;gap:12px;padding:16px 32px;border-radius:14px;background:#5865f2;color:#fff;font-family:'Outfit',sans-serif;font-size:16px;font-weight:800;text-decoration:none;box-shadow:0 8px 28px rgba(88,101,242,.55);transition:transform .2s,box-shadow .2s;width:100%;justify-content:center;"
           onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 14px 40px rgba(88,101,242,.75)'"
           onmouseout="this.style.transform='';this.style.boxShadow='0 8px 28px rgba(88,101,242,.55)'">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M20.317 4.492c-1.53-.69-3.17-1.2-4.885-1.49a.075.075 0 0 0-.079.036c-.21.369-.444.85-.608 1.23a18.566 18.566 0 0 0-5.487 0 12.36 12.36 0 0 0-.617-1.23A.077.077 0 0 0 8.562 3c-1.714.29-3.354.8-4.885 1.491a.07.07 0 0 0-.032.027C.533 9.093-.32 13.555.099 17.961a.08.08 0 0 0 .031.055 20.03 20.03 0 0 0 5.993 2.98.078.078 0 0 0 .084-.026c.462-.62.874-1.275 1.226-1.963.021-.04.001-.088-.041-.104a13.201 13.201 0 0 1-1.872-.878.075.075 0 0 1-.008-.125c.126-.093.252-.19.372-.287a.075.075 0 0 1 .078-.01c3.927 1.764 8.18 1.764 12.061 0a.075.075 0 0 1 .079.009c.12.098.245.195.372.288a.075.075 0 0 1-.006.125c-.598.344-1.22.635-1.873.877a.075.075 0 0 0-.041.105c.36.687.772 1.341 1.225 1.962a.077.077 0 0 0 .084.028 19.963 19.963 0 0 0 6.002-2.981.076.076 0 0 0 .032-.054c.5-5.094-.838-9.52-3.549-13.442a.06.06 0 0 0-.031-.028z"/></svg>
          Discord beitreten
        </a>
        <div style="font-size:13px;color:rgba(255,255,255,.35);text-align:center;margin-top:4px;line-height:1.6;">
          Klick auf den Button und tritt direkt unserem Server bei.<br>Alles weitere wird dort In-Character abgewickelt.
        </div>
      </div>
    `
  }
